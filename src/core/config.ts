...
// GBRAIN_CONFIG_DIR and GBRAIN_HOME are honored uniformly. Lazy: never call
// homedir() at module scope.
...
export function configDir(): string {
  ...
  // GBRAIN_CONFIG_DIR sets the config directory directly (used by the
  // brain-private wrapper to point at .gbrain-private/).
